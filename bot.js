...
client.on("guildMemberRemove", async member => {
  ...
  const background = await Canvas.loadImage(
    "https://cdn.discordapp.com/attachments/810218791517552650/823189189885165598/PicsArt_03-21-04.39.16.png"
  );
...
client.on("guildMemberAdd", async member => {
  ...
  const background = await Canvas.loadImage(
    "https://cdn.discordapp.com/attachments/810218791517552650/823191130496958514/PicsArt_03-21-04.46.25.png"
  );
  ctx.drawImage(background, 0, 0, canvas.width, canvas.height);
...
client.on('guildMemberAdd',async member => {
  ...
  const resim1 = await Canvas.loadImage('https://i.hizliresim.com/DWmOSd.png')
    ...
    if (kurulus < 2629800000) kontrol = resim1
     ...
     const background = await Canvas.loadImage("https://cdn.discordapp.com/attachments/808399918468562945/823901211648065557/vexy_guvenlik.png");
       ctx.drawImage(background, 0, 0, canvas.width, canvas.height);
...
client.on("guildMemberAdd", member => {
  ...
  if (ayyy < 1) {
    kontrol = "**Şüpheli** <:X_Tik:811147172422746143> ";
  }
  if (ayyy > 1) {
    kontrol = "**Güvenilir** <a:Mavi_Tik:808696810096820244> ";
  }
  ...
  ///////////////////
    if(!gif) gif = "https://cdn.discordapp.com/avatars/811238807692771348/97c8b0030749254cb2dbc7eb5cb691db.webp"
  const embed = new Discord.MessageEmbed()
    .setColor("36393F")
    .setImage(`${gif}`)
    .setThumbnail(
    ...
    .setDescription(
      `<a:Giris:808698271253659668>  **Hoşgeldin!** ${
        member.user
      }, seninle beraber **${
        guild.memberCount
...
client.emojiler = {
  gold: "818203267250913340", //?PARAM DAKİ ALTIN EMOJİSİ
  paraGitti: ":outbox_tray:", // X İŞARETİ
  paraGitmedi: ":inbox_tray:", // TİK İŞARETİ
  paraROZET: "818207414884106260", // PARA İLE ALINAN YILDIRIM ROZET EMOJİSİ
  onayRozet: "818206896430252032", // ONAY ROZETİ
  modRozet: "818210265744015381", // MOD ROZETİ
  yetkiliRozet: "818210265744015381", // YETKİLİ ROZETİ
...
client.ayarlar = {
  ...
  isim: "Wexy",
  botD:
    "https://discordapp.com/oauth2/authorize?client_id=811238807692771348&scope=bot&permissions=8",
  webS: "",
  web: "",
  site: "",
  dblO: "https://discordbots.org/bot/811238807692771348/vote",
  dbl: "https://discordbots.org/bot/811238807692771348",
  dbltoken:
        "",
  webpanel: "",
  versiyon: "2.0",
...
if(Date.now() < maxTime) {
 ...
 message.channel.send(westraaaaam).then(msg => msg.delete({timeout: 500}));
...
.addField("Sunucudaki Kişi Sayısı:", guild.memberCount)
   ...
   client.channels.cache.get('819041898067918870').send(plasmic);
...
.addField("Sunucudaki Kişi Sayısı:", guild.memberCount)
   ...
   client.channels.cache.get('819041874588467220').send(plasmicc);

}); 
//eklendim atildim bitis
//dmlog
client.on("message", msg => {
var dm = client.channels.cache.get("819041922643263508")
